...
export default function Home() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-[#F7F3E8] to-white py-20 lg:py-32">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={createPageUrl('Contact')} onClick={() => trackEvent('hero_book_call_click')}>
                <Button size="lg" className="bg-[#1F3D2B] hover:bg-[#2A553A] text-white w-full sm:w-auto">
                  Book 30-Min Call <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Link to={createPageUrl('Contact')} onClick={() => trackEvent('hero_get_plan_click')}>
                <Button size="lg" variant="outline" className="border-2 border-[#1F3D2B] text-[#1F3D2B] hover:bg-[#F7F3E8] w-full sm:w-auto">
                  See Pricing
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            {[
              ...
              <div key={idx} className="flex items-start gap-3 p-4 bg-white rounded-lg border-l-4 border-[#6B4E3D] border border-[#E6E0D5] shadow-sm">
                <X className="w-5 h-5 text-[#6B4E3D] flex-shrink-0 mt-0.5" />
                <p className="text-[#1A1A1A] font-medium">{problem}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-[#F7F3E8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-10">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-[#E6E0D5]">
              <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6">For Wholesale (B2B)</h3>
              <ul className="space-y-4 mb-6">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#6B8F71] mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-[#1A1A1A] font-semibold">Wholesale kit sends itself</span>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#6B8F71] mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-[#1A1A1A] font-semibold">Follow-up reminders built in</span>
              ...
              <Link to={createPageUrl('WholesaleGrowth')}>
                <Button className="w-full bg-[#1F3D2B] hover:bg-[#2A553A] text-white">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-[#E6E0D5]">
              <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6">For Direct Sales (B2C)</h3>
              <ul className="space-y-4 mb-6">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#6B8F71] mt-0.5 flex-shrink-0" />
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#6B8F71] mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-[#1A1A1A] font-semibold">Content system you can actually do</span>
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#6B8F71] mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-[#1A1A1A] font-semibold">Know what converts</span>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            {/* Foundation Package */}
            <div className="bg-white rounded-xl border-2 border-[#E6E0D5] p-8">
            ...
            {/* Growth Package */}
            <div className="bg-[#EEF3EC] rounded-xl border-2 border-[#6B8F71] p-8 relative">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <span className="bg-[#1F3D2B] text-white text-xs font-bold px-3 py-1 rounded-full">MOST POPULAR</span>
              </div>
          ...
          <div className="bg-[#F7F3E8] rounded-xl p-8 border border-[#E6E0D5] mb-6">
          ...
          <div className="bg-[#1F3D2B] text-white rounded-xl p-6 text-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 mb-10">
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <p className="font-bold text-[#1A1A1A] mb-2">"I already have 3 buyers. Why do I need a system?"</p>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <p className="font-bold text-[#1A1A1A] mb-2">"What if I can't fulfill the orders?"</p>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <p className="font-bold text-[#1A1A1A] mb-2">"I'm not a marketer. I don't know what content to make."</p>
      ...
      <section className="py-16 bg-[#F7F3E8]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            <div className="bg-white rounded-lg p-6 border border-[#E6E0D5] shadow-sm">
              <div className="text-[#1F3D2B] font-bold text-sm mb-2">WEEK 1</div>
            ...
            <div className="bg-white rounded-lg p-6 border border-[#E6E0D5] shadow-sm">
              <div className="text-[#1F3D2B] font-bold text-sm mb-2">WEEKS 2-3</div>
            ...
            <div className="bg-white rounded-lg p-6 border border-[#E6E0D5] shadow-sm">
              <div className="text-[#1F3D2B] font-bold text-sm mb-2">WEEK 4</div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <div className="text-3xl font-bold text-[#1F3D2B] mb-2">10 hrs/week saved</div>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <div className="text-3xl font-bold text-[#1F3D2B] mb-2">3 new accounts in 60 days</div>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <div className="text-3xl font-bold text-[#1F3D2B] mb-2">47 preorders in 72 hours</div>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-[#6B8F71] border border-[#E6E0D5] shadow-sm">
              <div className="text-3xl font-bold text-[#1F3D2B] mb-2">$0 wasted ad spend</div>
      ...
      <section className="py-20 bg-[#1F3D2B] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to={createPageUrl('Contact')} onClick={() => trackEvent('footer_cta_click')}>
            <Button size="lg" className="bg-white text-[#1F3D2B] hover:bg-[#F7F3E8]">
